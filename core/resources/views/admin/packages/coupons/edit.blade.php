                    ...
                    <div class="row no-gutters">
                      <div class="col-lg-6">
                          <div class="form-group">
                              ...
                              <select class="select2" name="packages[]" multiple="multiple" placeholder="Select Packages">
                                  @foreach ($packages as $package)
                                      <option value="{{$package->id}}" {{is_array($selectedPackages) && in_array($package->id, $selectedPackages) ? 'selected' : ''}}>
