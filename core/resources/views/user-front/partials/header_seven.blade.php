    ...
    <header class="header-area header-area-4">
                                    ...
                                    <ul>
                                        @if (count($emails) > 0)
                                            <li class="d-none d-lg-inline-block">
                                                <i class="far fa-envelope"></i><span>{{ $emails[0] }}</span>
                                            </li>
                                        @endif
                                        @if (count($phone_numbers) > 0)
                                            <li class="d-none d-lg-inline-block"><i class="far fa-phone"></i><span>{{ $phone_numbers[0] }}</span>
                                            </li>
                                        @endif
                                        <li class="mt-lg-0 mt-2 pb-md-0 pb-3">
                                            <form action="{{ route('changeUserLanguage', getParam()) }}"
                                                id="userLangForms">
                                                @csrf
        ...
        @if (count($social_medias) == 0 && count($phone_numbers) == 0 && count($emails) == 0)
            <style>
