            ...
            <div class="hero-slider-one">
                @if (count($sliders) > 0)
                    @foreach ($sliders as $slider)
                        <div class="single-slider bg-with-overlay bg_cover lazy"
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-7">
                                        <div class="hero-content hero-content-center">
                                            ...
                                            <h4 data-animation="fadeInDown" data-delay=".55s">{{ $slider->subtitle }}</h4>
                    ...
                    <div class="col-lg-6">
                        @foreach ($work_processes as $key => $work_process)
                            <div class="service-item service-item-one wow fadeInUp" data-wow-delay=".2s">
                                ...
                                <div class="content">
                                    <h3 class="title">
                                        <a href="practice-details.html">{{ $work_process->title }}</a>
                                    </h3>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="team-item team-item-one mb-40 wow fadeInUp" data-wow-delay=".25s">
                                ...
                                <div class="team-content">
                                    <h3 class="title"><a
                                            href="attorney-details.html">{{ convertUtf8($team->name) }} </a></h3>
