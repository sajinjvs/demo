...
@section('content')
   ...
   <section class="hero-area-two have-animate-icons">
    ...
    <div class="animate-icons">
        <img src="{{asset('assets/front/img/static/theme45/gradient-pipe.png')}}" alt="particles" class="icon-one animate-rotate-me">
        <img src="{{asset('assets/front/img/static/theme45/wave-line.png')}}" alt="particles" class="icon-two animate-float-bob-x">
        <img src="{{asset('assets/front/img/static/theme45/stars.png')}}" alt="particles" class="icon-three animate-float-bob-x">
        <img src="{{asset('assets/front/img/static/theme45/triangle.png')}}" alt="particles" class="icon-four animate-float-bob-y">
        <img src="{{asset('assets/front/img/static/theme45/triangle-2.png')}}" alt="particles" class="icon-five animate-rotate-me">
        <img src="{{asset('assets/front/img/static/theme45/circle.png')}}" alt="particles" class="icon-six animate-zoom-fade">
        <img src="{{asset('assets/front/img/static/theme45/circle-small.png')}}" alt="particles" class="icon-seven animate-float-bob-y">
    </div>
</section>
<!--====== End Hero Area ======-->
                    ...
                    <div class="col-lg-4 col-sm-6 wow fadeInUp">
                        <div class="iconic-box icon-left mt-30">
                            ...
                            <div class="content">
                                ...
                                <p>{!! strlen(strip_tags($service->content)) > 80 ? mb_substr(strip_tags($service->content), 0, 80, 'UTF-8') . '...' : strip_tags($service->content) !!}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-6 col-md-10">
                        <div class="feature-images row align-items-center content-mb-md-50">
                            <div class="col-md-12">
                                <img data-src="{{ isset($home_text->work_process_section_img)? asset('assets/front/img/work_process/' . $home_text->work_process_section_img): asset('assets/front/img/static/theme45/about.png') }}"
                    ...
                    <div class="col-lg-6 col-md-10">
                        <div class="feature-text-block content-l-spacing">
                            <div class="section-heading mb-50">
                                ...
                                @endisset
                                <span
                                    class="tagline">{{ $home_text->work_process_section_subtitle ?? null }}</span>
                    ...
                    <div class="fancy-image-gallery content-l-spacing content-mt-md-50">
                        <div class="images-wrap">
                            <div class="wow fadeInUp" data-wow-delay="0.1s">
                                <img class="lazy"
                                    data-src="{{ !empty($home_text->contact_section_image)? asset('assets/front/img/user/home_settings/' . $home_text->contact_section_image): asset('assets/front/img/static/theme45/contact.png') }}"
                                    alt="Image">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="content-left">
                        <div class="tilke-video lazy"
                            ...
                            @if (!empty($home_text->video_section_url))
                                <a href="{{ $home_text->video_section_url }}" class="video-popup" data-lity><i
