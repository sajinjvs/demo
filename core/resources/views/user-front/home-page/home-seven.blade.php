...
@section('content')
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-9">
                                <div class="banner-content text-center">
                                    ...
                                    <ul>
                                        <li><a data-animation="fadeInLeft" data-delay="1.5s" class="main-btn"
                                                href="#">read more <i class="flaticon-arrow-pointing-to-right"></i></a>
                                        </li>
                                    </ul>
                                </div> <!-- banner content -->
                            </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="about-features mt-30">
                                        ...
                                        @if (!empty($work_process->text))
                                            <p>{!! strlen(strip_tags($work_process->text)) > 80 ? mb_substr(strip_tags($work_process->text), 0, 80, 'UTF-8') . '...' : strip_tags($work_process->text) !!}</p>
                                        @endif
                                    </div>
                                </div>
                            @endforeach
    ...
    @if (isset($home_sections->video_section) && $home_sections->video_section == 1)
        ...
        <section class="video-area">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-7">
                        <div class="video-thumb">
                            <img data-src="{{ asset('assets/front/img/user/home_settings/' . $videoBg) }}"
                                class="lazy" alt="video">
                            <div class="video-overlay">
                                @if (!empty($home_text->video_section_url))
                                    <a class="video-popup" href="{{ $home_text->video_section_url }}"><i
                    ...
                    <div class="col-lg-5">
                        <div class="video-content">
                            ...
                            <h3 class="title">{{ $home_text->video_section_title }}</h3>
                            @endif
            ...
            <div class="video-dot">
                <img src="{{asset('assets/front/img/static/industry/video-dot.png')}}" alt="dot">
            </div>
        </section>
        <!--====== VIDEO PART ENDS ======-->
    @endif
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="progress-counter mt-30">
                                <div class="history-progress text-center">
                                    ...
                                    <h2 class="title"><span
                                            class="counter">{{ $counterInformation->count }}</span></h2>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="section-title-4 text-center">
                            ...
                            @endif
                            <p>{{$home_text->service_subtitle ?? null}}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="section-title-4 text-center">
                            ...
                            @endisset
                            <p>{{ $home_text->team_section_subtitle ?? null }}</p>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-8">
                            <div class="single-team mt-30">
                                <div class="team-thumb">
                                    <img class="lazy"
                                        data-src="{{ asset('/assets/front/img/user/team/' . $team->image) }}" alt="team">
                                </div>
                ...
                <div class="row">
                        ...
                        <div class="quote-form">
                            <form action="{{ route('front.contact.message', getParam()) }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="input-box mt-30">
                                            <textarea name="message" id="#" cols="30" rows="10" placeholder="{{ $keywords['Message'] ?? 'Message' }}"></textarea>
                    ...
                    <div class="col-lg-5">
                        <div class="quote-thumb d-none d-lg-inline-block">
                            <img data-src="{{ !empty($home_text->contact_section_image)? asset('assets/front/img/user/home_settings/' . $home_text->contact_section_image): asset('assets/front/img/static/industry/quote-thumb.jpg') }}"
