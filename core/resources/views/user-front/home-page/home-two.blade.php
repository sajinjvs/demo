                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-10">
                                    <div class="banner-content text-center">
                                        <h1 data-animation="fadeInDown" data-delay="0.8s">{{ convertUtf8($slider->title) }}
                                        </h1>
                                        <p data-animation="fadeInUp" data-delay="1s">{{ convertUtf8($slider->subtitle) }}
                                        </p>
                                        <ul class="btn-wrap">
                ...
                <div class="single-banner"
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-10">
                                <div class="banner-content text-center">
                                    <h1 data-animation="fadeInDown" data-delay="0.8s">Take Great Idea To Grow Your Business
                                    </h1>
                    ...
                    <div class="col-lg-10">
                        <div class="video-cont text-center">
                            @if (!empty($home_text->video_section_url))
                                <a href="{{ $home_text->video_section_url }}" class="play-btn popup-video wow fadeInDown"
                        ...
                        @foreach ($brands as $brand)
                            <div class="col">
                                <a href="{{ $brand->brand_url }}" class="client-img d-block text-center" target="_blank">
                                    <img class="lazy"
                                        data-src="{{ asset('assets/front/img/user/brands/' . $brand->brand_img) }}" alt="">
                                </a>
                            </div>
                        @endforeach
                    </div>
