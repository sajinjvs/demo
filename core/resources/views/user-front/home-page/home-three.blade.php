                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-7 d-none d-md-block">
                            <div class="banner-img text-right wow fadeInRight" data-wow-duration="1500ms"
                                ...
                                @else
                                    <img class="lazy"
                                        data-src="{{ asset('assets/front/img/hero_static/hero_3.png') }}"
                                        alt="Hero Image">
                                @endif
                            </div>
                        </div>
        ...
        <section class="faq-section section-gap with-illustration with-shape grey-bg">
            <div class="container">
                ...
                <div class="row justify-content-lg-end justify-content-center">
                    <div class="col-lg-6">
                        <img class="lazy"
                            data-src="{{ asset('assets/front/img/user/home_settings/' . $faqBg) }}" alt="illustration">
                    </div>
                    <div class="col-lg-6">
                        ...
                        <div class="col">
                            <div class="team-member">
                                ...
                                <div class="member-desc">
                                    <h3 class="name"><a
                                            href="javascript:void(0)">{{ convertUtf8($team->name) }}</a></h3>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="input-group textarea mb-30">
                                                <textarea placeholder="{{ $keywords['Message'] ?? 'Message' }}"
