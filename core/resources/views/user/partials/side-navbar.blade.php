        ...
        <div class="sidebar-content">
            ...
            <ul class="nav nav-primary">
                    ...
                    <li
                        ...
                        @elseif(request()->is('user/testimonial/*/edit')) show @endif "
                            ...
                            <ul class="nav nav-collapse">
                                ...
                                @if ($userBs->theme == 'home_three' || $userBs->theme == 'home_four' || $userBs->theme == 'home_five')
                                    <li
                                        class="
                            @if (request()->routeIs('user.home_page.hero.static_version')) active @endif">
                                        <a
                                ...
                                @endif
                                @if ($userBs->theme == 'home_one' || $userBs->theme == 'home_two' || $userBs->theme == 'home_six' || $userBs->theme == 'home_seven')
                                    <li
                            ...
                            @elseif (request()->routeIs('user.home_page.hero.edit_slider')) active @endif">
                                ...
                                @if ($userBs->theme != 'home_three')
                                    <li class="@if (request()->routeIs('user.home.page.video')) active @endif">
                                        <a
                                            href="{{ route('user.home.page.video', ['language' => $default->code]) }}">
                ...
                @if (!empty($permissions) && in_array('Service', $permissions))
                    <li class="nav-item
                    @if (request()->path() == 'user/services') active @endif">
                ...
                @if (!is_null($package))
                    ...
                    @elseif(request()->path() == 'user/mail/information/subscriber') active @endif">
                        ...
                        @elseif(request()->path() == 'user/mail/information/subscriber') show @endif"
                            id="subscribers">
                            <ul class="nav nav-collapse">
