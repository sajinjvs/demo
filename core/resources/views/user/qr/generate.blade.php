    ...
    <div class="col-lg-5">
        <div class="card bg-white">
            ...
            <div class="card-footer text-center border-top">
                <a id="downloadBtn" class="btn btn-success" download="qr-image.png" href="{{asset('assets/front/img/user/qr/' . $abs->qr_image)}}">{{__('Download Image')}}</a>
            </div>
        </div>
...
<script src="{{asset('assets/front/user/js/qr.js')}}"></script>
@endsection