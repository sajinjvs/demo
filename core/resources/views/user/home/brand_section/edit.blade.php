    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form
          id="ajaxEditForm"
          class="modal-form"
          action="{{ route('user.home_page.brand_section.update_brand') }}"
          method="POST"
        ...
        >
          ...
          <input type="hidden" id="in_id" name="brand_id">
            <div class="form-group">
                ...
                <div class="col-md-12 showEditImage mb-3">
                    <img
                        src=""
                        alt="..." class="brand-img img-thumbnail">
                </div>
                <input type="file" name="brand_img" id="edit_image"
          ...
          <div class="form-group">
            ...
            <input type="url" id="in_brand_url" class="form-control ltr" name="brand_url" placeholder="{{__('Enter Brand URL')}}">
