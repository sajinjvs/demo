                ...
                <div class="row no-gutters">
                    <div class="col-lg-4">
                        <div class="card border-primary mb-3">
                            ...
                            <div class="card-body">
                                <ul class="list-group">
                                    <li class="list-group-item">{{$keywords['Home'] ?? 'Home'}} <a data-text="{{$keywords['Home'] ?? 'Home'}}" data-type="home" class="addToMenus btn btn-primary btn-sm float-right" href="">{{__('Add to Menus')}}</a></li>

                                    @if (!empty($permissions) && in_array('Service', $permissions))
                                    <li class="list-group-item">{{$keywords['Services'] ?? 'Services'}} <a data-text="{{$keywords['Services'] ?? 'Services'}}" data-type="services" class="addToMenus btn btn-primary btn-sm float-right" href="">{{__('Add to Menus')}}</a></li>
                                    @endif

                                    @if (!empty($permissions) && in_array('Blog', $permissions))
                                    <li class="list-group-item">{{$keywords['Blog'] ?? 'Blog'}} <a data-text="{{$keywords['Blog'] ?? 'Blog'}}" data-type="blog" class="addToMenus btn btn-primary btn-sm float-right" href="">{{__('Add to Menus')}}</a></li>
                                    @endif
                                    ...
                                    <li class="list-group-item">{{$keywords['Contact'] ?? 'Contact'}} <a data-text="{{$keywords['Contact'] ?? 'Contact'}}" data-type="contact" class="addToMenus btn btn-primary btn-sm float-right" href="">{{__('Add to Menus')}}</a></li>

                                    @if (!empty($permissions) && in_array('Team', $permissions))
                                    <li class="list-group-item">{{$keywords['Team'] ?? 'Team'}} <a data-text="{{$keywords['Team'] ?? 'Team'}}" data-type="team" class="addToMenus btn btn-primary btn-sm float-right" href="">{{__('Add to Menus')}}</a></li>
                                    @endif

                                    @if (!empty($permissions) && in_array('Career', $permissions))
                                    <li class="list-group-item">{{$keywords['Career'] ?? 'Career'}} <a data-text="{{$keywords['Career'] ?? 'Career'}}" data-type="career" class="addToMenus btn btn-primary btn-sm float-right" href="">{{__('Add to Menus')}}</a></li>
                                    @endif

                                    <li class="list-group-item">{{$keywords['FAQ'] ?? 'FAQ'}} <a data-text="{{$keywords['FAQ'] ?? 'FAQ'}}" data-type="faq" class="addToMenus btn btn-primary btn-sm float-right" href="">{{__('Add to Menus')}}</a></li>
