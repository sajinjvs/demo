...
<div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="dot mb-40">
                      ...
                      <div class="content">
                         <h4>Dashboards</h4>
                          <p>Shadobooks offer an intuitive dashboard that helps you with a brief overview of all your sales pipelines, KPIs, lead management, project reminders, and invoice regulations.
                            ...
                            Since they offer complete integration assistance, you can practically bring all your finance and accounting data under one roof.</span>
                          </p>
                        </div>
                          <a class="more"></a>
                    </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-12">
           <div class="dot mb-40">
              <div class="content">
                ...
                expiration dates, taxing, SKU codes, warehouse availability and order management. There’s also a wide scope of integrations with all your operational software tools to make easy for you to manage all your operations under one roof. <br><br>
          ...
          <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="dot mb-40">
              <div class="content">
                  <h4>Fixed Assets</h4>
                    <p>The fixed asset section of the platform enables end-to-end visibility of the management process starting from acquisition to disposition. Shadobook offers an elaborate portal for complete tracking of asset movements across your enterprise, request management and also ensure compliance
                      through periodical audits. You can easily maintain, monitor, and manage business assets along with maintenance reporting, audit compliance, licenses management and also asserting depreciation values. <br><br>
