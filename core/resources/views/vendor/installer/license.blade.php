        ...
        <form method="post" action="{{ route('LaravelInstaller::licenseCheck') }}" class="tabs-wrap">
            ...
            <div>
                ...
                <div class="form-group {{ $errors->has('username') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="username" id="username" value="" placeholder="Username of Your bizzonit Account" />
                ...
                <div class="form-group {{ $errors->has('bizz_verification') ? ' has-error ' : '' }}">
                    <label for="bizz_verification">
                        Bizz Verification
                    </label>
                    <input type="text" name="bizz_verification" id="bizz_verification" value="" placeholder="Your Item Bizz Verification" />
                    @if ($errors->has('bizz_verification'))
                        <span class="error-block">
                            <i class="fa fa-fw fa-exclamation-triangle" aria-hidden="true"></i>
                            {{ $errors->first('bizz_verification') }}
                        </span>
                    @endif
                </div>
